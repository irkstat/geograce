...
<body>
    ...
    <div class="description_general">
        ...
        <p class="list_description_general">1. путем передачи азимутов по сторонам геодезической сети, пользуясь исходным азимутом в начальной ее точке, полученным при ориентировании референц-эллипсоида, и углами сети;</p>
        <p class="list_description_general">2. путем определения астрономического азимута &alpha; <sub>ik</sub> и получения затем геодезического азимута A <sub>ik</sub> направления <em>ik</em> по формуле:</p>
